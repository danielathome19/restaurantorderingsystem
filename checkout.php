            ...
            <div class="col-75" style="margin: 15px;">
                ...
                <form action="controllers/pushtransaction.php" method="POST" id="checkoutform">
                    ...
                    <div class="col-50">
                        ...
                        <select style="margin: 10px; height: 30px; width: 250px;" id="payment_profile" name="payment_profile" onchange="onPaymentProfileChange(this)">
                    ...
                    <select style="margin: 10px; height: 30px; width: 250px;" id="selector" name="selector" onChange="isDelivery()" form="checkoutform" required>

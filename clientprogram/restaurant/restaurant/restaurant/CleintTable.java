...
public class CleintTable 
{
	...
	{
		restaurant.ConnectToDB content;
		content = new restaurant.ConnectToDB();
	...
	public void table()
	{
		...
		complete.setBounds(50,460,220,20);
		if(index != -1)
		{
			complete.addActionListener(e -> {
			
			try {
				restaurant.UpdateOrder up = new restaurant.UpdateOrder(index);
				up.update();
		...
		update.addActionListener(e ->
		{
			restaurant.SendEmail send = new restaurant.SendEmail ();
